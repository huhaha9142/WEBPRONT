...
console.log(s1[7]); //  배열처럼 사용할 수 있다. 다만, 불변 자료형 ex) s1[77] = "j" (x)
//  부분 문자열 메서드
console.log(s1.substr(7));  //  7번 인덱스 ~ 끝까지 -> JavaScript and Java
console.log(s1.substr(7, 10));  //  7번 인덱스 ~ 10글자 ->  JavaScript
console.log(s1.substring(7));   //  7번 인덱스 ~ 끝까지 -> JavaScript and Java
console.log(s1.substring(7, 17));   //  7번 인덱스 ~ 17번 인덱스 앞까지 -> JavaScript
...
//  문자열 치환: replace
console.log(s1.replace("JavaScript", "JS"));    //  문자열 내의 JavaScript -> JS
//  String은 불변 자료형: 내부 데이터는 변경되지 않는다
console.log("원본:", s1);
