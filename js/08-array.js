...
//  push + pop : Stack처럼 활용 (Java의 Stack)
...
//  push + shift : QUEUE 자료형처럼 활용 (Java의 Queue)
...
fruits = ['Banana', 'Orange', 'Apple', 'Mango'];
console.log("원본:", fruits);
//  인수가 2개 : 1번째 인수 인덱스 부터, 2번째 인수 개수만큼
//                 추출 후 제거
...
const str = "JavaScript is something strange than oter languages";
